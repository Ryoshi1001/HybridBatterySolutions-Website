      ...
      <div className="flex items-center justify-center flex-wrap gap-4 py-4 px-4">
        <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900">
          ...
          <p className="text-sm text-neutral-600 dark:text-neutral-400 line-clamp-6">
            Expert hybrid battery solutions for Toyota Prius models 2004-2016.
            Our specialized services include battery cell repair,
        ...
        <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900">
          ...
          />
          <p className="text-base sm:text-xl text-black mt-4 mb-2 dark:text-neutral-200">
            Toyota Camry Hybrid (2007-2015)
          </p>

          <p className="text-sm text-neutral-600 dark:text-neutral-400 line-clamp-6">
            Specialized hybrid battery solutions for Toyota Camry Hybrid models
            2007-2015. Our services include battery pack
        ...
        <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900">
          ...
          />
          <p className="text-base sm:text-xl text-black mt-4 mb-2 dark:text-neutral-200">
            Nissan Altima (2007-2015) & Select Lexus Models 
          </p>
